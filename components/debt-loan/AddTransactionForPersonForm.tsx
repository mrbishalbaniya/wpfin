...
interface AddTransactionForPersonFormProps {
  person: string
  onSuccess?: () => void
}

export default function AddTransactionForPersonForm({ person, onSuccess }: AddTransactionForPersonFormProps) {
            ...
            <SelectContent>
              <SelectItem value="lent">
                <div className="flex items-center space-x-2">
                  ...
                  <span>I Lent Money to {person}</span>
                </div>
              </SelectItem>
              <SelectItem value="borrowed">
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 rounded-full bg-red-500" />
                  <span>I Borrowed Money from {person}</span>
                </div>
              </SelectItem>
            </SelectContent>
          </Select>
